...
class PinterestAuthSettingsForm extends SocialAuthSettingsForm {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['pinterest_settings'] = [
      ...
      '#open' => TRUE,
      '#description' => $this->t('You need to first create a Pinterest App at <a href="@pinterest-dev">@pinterest-dev</a>', ['@pinterest-dev' => 'https://developers.pinterest.com/apps/']),
    ];
    ...
    $form['pinterest_settings']['authorized_redirect_url'] = [
      ...
      '#description' => $this->t('Copy this value to <em>Valid redirect URIs</em> field of your Pinterest App settings.'),
      '#default_value' => $GLOBALS['base_url'] . '/user/login/pinterest/callback',
    ];
    ...
    $form['pinterest_settings']['advanced']['scopes'] = [
      ...
      '#description' => $this->t('Define any additional scopes to be requested, separated by a comma (e.g.: comments,likes).<br>
                                  ...
                                  You can see the full list of valid scopes and their description <a href="@scopes">here</a>.', ['@scopes' => 'https://www.pinterest.com/developer/authorization/']),
    ];
